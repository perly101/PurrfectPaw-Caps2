{{-- resources/views/clinic/thank-you-pending.blade.php --}}
    ...
    <div class="min-h-screen bg-gray-100 py-6 flex flex-col justify-center">
        <div class="sm:max-w-xl md:max-w-2xl mx-auto">
            <div class="text-center mb-10">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-gray-800">Payment Submitted</h2>
                <p class="text-gray-500 text-base md:text-lg mt-3">Your payment is being reviewed by our admin team</p>
            </div>
            
            <div class="bg-white shadow-lg rounded-xl p-6 md:p-8 border border-gray-200">
                <div class="text-center mb-6">
                    <h3 class="text-xl font-semibold text-gray-800">Admin Approval Required</h3>
                    <p class="text-gray-600 mt-2">Your payment needs to be confirmed by an administrator</p>
                    <div class="mt-4">
                        <span class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1.5 text-yellow-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                <ol class="list-decimal list-inside space-y-1 pl-2">
                                    <li><span class="font-medium">Admin Review</span>: Our admin team will verify your payment (usually within 24 hours)</li>
                                    <li><span class="font-medium">Account Activation</span>: Once approved, your clinic account will be activated</li>
                                    <li><span class="font-medium">Email Confirmation</span>: You'll receive an email notification when your clinic is active</li>
                                    <li><span class="font-medium">Start Using PurrfectPaw</span>: Log in and set up your clinic profile</li>
                                </ol>
                            </div>
                        </div>
                    </div>
