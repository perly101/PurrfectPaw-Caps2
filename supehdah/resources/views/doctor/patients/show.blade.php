                    ...
                    <div class="bg-gray-50 p-4 rounded-lg mb-6">
                        <div class="flex flex-wrap justify-between">
                            ...
                            <div class="text-right">
                                <p class="text-gray-500">First Visit: {{ $appointments->last()->created_at->format('F d, Y') }}</p>
                                ...
                                <div class="space-y-6">
                                    @foreach($appointments as $index => $appointment)
                                        <div class="border-b pb-6 last:border-b-0 last:pb-0">
                                            ...
                                            <div class="mt-2">
                                                <a href="{{ route('doctor.appointments.show', $appointment->id) }}" class="text-blue-600 hover:text-blue-900">
