            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div class="bg-white shadow-lg rounded-xl p-6 border border-gray-200">
                        ...
                        <div class="flex items-baseline">
                            <p class="text-3xl font-bold text-gray-800" id="user-count">{{ \App\Models\User::where('role','user')->count() }}</p>
                            <span class="ml-2 text-sm text-gray-500">registered users</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white shadow-lg rounded-xl p-6 border border-gray-200">
                        ...
                        <div class="flex items-baseline">
                            <p class="text-3xl font-bold text-gray-800" id="clinic-count">{{ \App\Models\User::where('role','clinic')->count() }}</p>
                            <span class="ml-2 text-sm text-gray-500">registered clinics</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white shadow-lg rounded-xl p-6 border border-gray-200">
                        ...
                        <div class="flex items-baseline">
                            <p class="text-3xl font-bold text-gray-800" id="today-count">{{ \App\Models\User::whereDate('created_at', today())->count() }}</p>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">{{ $user->first_name }} {{ $user->middle_name ? $user->middle_name . ' ' : '' }}{{ $user->last_name }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white shadow-lg rounded-xl p-6 lg:col-span-2 border border-gray-200">
                        <h3 class="text-lg font-semibold mb-4 text-gray-800">Monthly Registrations</h3>
                    ...
                    {{-- Quick Stats --}}
                    <div class="bg-white shadow-lg rounded-xl p-6 border border-gray-200">
                        <h3 class="text-lg font-semibold mb-4 text-gray-800">Activity Summary</h3>
                        <div class="space-y-4">
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-gray-600">Active Users (Last 7 days)</span>
                                <span class="font-semibold text-gray-800">{{ rand(30, 100) }}</span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-gray-600">New Appointments</span>
                                <span class="font-semibold text-gray-800">{{ rand(5, 25) }}</span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-gray-600">Pending Approvals</span>
                                <span class="font-semibold text-gray-800">{{ rand(0, 10) }}</span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-gray-600">System Uptime</span>
                                <span class="font-semibold text-gray-800">99.9%</span>
                            </div>
                        </div>
                    </div>
                </div>
